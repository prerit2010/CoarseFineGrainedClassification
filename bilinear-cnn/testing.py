...
model=torch.load('model/coarse_grained_vgg_with_fine_tune.pth')

print("Performing coarse grained classification")
...
print(os.listdir("final_test_data"))
...
#     for i in os.listdir("coarse_test/" + category):
    ...
    directory = "data/testing/" + coarse_class
    if not os.path.exists(directory):
        os.makedirs(directory)
    dest = "data/testing/" + coarse_class + "/" + img
    copyfile(src, dest)
    print(dest)
