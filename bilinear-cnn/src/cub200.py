...
#       
        image_path = "data/" + coarse_class + "/raw/"  + coarse_class + "/images"
       
        id2name = np.genfromtxt("data/" + coarse_class + "/raw/" + coarse_class + "/images.txt", dtype=str)

        id2train = np.genfromtxt("data/" + coarse_class + "/raw/"  + coarse_class + "/train_test_split.txt", dtype=int)
...
#                     open('data/cub200/processed/test.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        ...
        pickle.dump((train_data, train_labels),
                    open("data/"  + coarse_class +  "/processed/train.pkl", 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
                    
        pickle.dump((test_data, test_labels),
                    open('data/'  + coarse_class + '/processed/test.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
